...
\newcommand{\degree}{Future Network Systems} % Replace with your degree name, this is used in the title page and abstract
\newcommand{\typeofthesis}{dissertation} % dissertation, Final Year Project, report, etc.
\newcommand{\authorname}{Mykola Vaskevych} % Your name, this is used in the title page and PDF stuff
...
% \newcommand{\supervisor}{Associate Prof. Stephen Farrell} % replace with the name of your supervisor
\newcommand{\supervisor}{Associate Prof. Research Fellow, Stephen Farrell} % replace with the name of your supervisor
